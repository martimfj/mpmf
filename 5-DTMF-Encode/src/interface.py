...
class Main(object):
    ...
    def Tone1(self):
        encoderDTMF.encoder().makeTone("T1")

    # def Tone2(self):
    #     self.encoderDTMF.makeTone("T2")

    # def Tone3(self):
    #     encoderDTMF.makeTone("T3")

    # def Tone4(self):
    #     encoderDTMF.makeTone("T4")

    # def Tone5(self):
    #     encoderDTMF.makeTone("T5")

    # def Tone6(self):
    #     encoderDTMF.makeTone("T6")

    # def Tone7(self):
    #     encoderDTMF.makeTone("T7")

    # def Tone8(self):
    #     encoderDTMF.makeTone("T8")

    # def Tone9(self):
    #     encoderDTMF.makeTone("T9")

    # def Tone0(self):
    #     encoderDTMF.makeTone("T0")

    # def ToneA(self):
    #     encoderDTMF.makeTone("TA")

    # def ToneH(self):
    #     encoderDTMF.makeTone("TH")
